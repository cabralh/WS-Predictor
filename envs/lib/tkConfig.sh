...
# installed.
TK_PREFIX='/home/cabralh/Documents/Projects/Machine-Learning/WS-Predictor/envs'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/cabralh/Documents/Projects/Machine-Learning/WS-Predictor/envs'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/cabralh/Documents/Projects/Machine-Learning/WS-Predictor/envs/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/cabralh/Documents/Projects/Machine-Learning/WS-Predictor/envs/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/cabralh/Documents/Projects/Machine-Learning/WS-Predictor/envs/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1592503156360/work/tk8.6.10/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/cabralh/Documents/Projects/Machine-Learning/WS-Predictor/envs/lib/libtkstub8.6.a'
